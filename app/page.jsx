  ...
  return (
    <div className="shell">
      ...
      <div className="phase">
        ...
        <p className="theme">The strategy is only as good as the people running it. How I hire, develop, and lead, and where I lean on HR as a real partner.</p>
        <ul>
          <li><b>I hire on CHAMP, not resume.</b> Coachable, Hardworking, Attitude, Motivated, Passionate. If a candidate has those five and can show me how they live them day to day, I will take them over someone who has sold PEO for twenty years. Skills can be taught; those five traits are who a person is. A team built on CHAMP is a team that adapts when the market shifts, which is exactly what a brand-new motion needs.</li>
          <li><b>Develop the whole team, not just the top two.</b> A team carried by a couple of stars is fragile, and it is a miserable place to be everyone else. The standard is the same for everyone, and I hold it even when it is inconvenient, because culture is not a kickoff speech, it is what you tolerate. That approach is how my team became the only one in the country to put 100 percent of its consultants in President's Club.</li>
          <li><b>Coach with evidence, then enable with tools.</b> When a rep is struggling, the first move is not a performance plan, it is the tape. I had a rep from a Big Four consulting background who spent four months proposing deals and losing. The instinct was to question his effort, but his calls told a different story: he was going too deep, over-preparing, and losing the prospect's attention. The fix was coaching him to keep it simple and giving him the formula my team had refined over years. He was stubborn, we went back and forth, and eventually I asked him to run it my way one time, and if we lost the deal he could go back to his own approach. He agreed, it worked, and he is now a top rep in the country. It taught me two things: teach the right approach from day one, and win or lose on the tools you give your team. The second is a big part of why I am excited to build enablement here.</li>
          <li><b>Direct and humane are not opposites.</b> The kindest thing you can do for a struggling rep is tell them the truth early and clearly, then build the plan with them, not at them. Softening the reality is not kindness, it is avoidance, and it only makes the hard conversation harder later.</li>
          <li><b>Design comp with HR and finance, never alone.</b> I have lived inside comp plans that paid for logos and got us logos that churned, and plans that rewarded the right behavior and changed a team overnight. I would design the PEO plan with HR and finance once I understand margin and CAC, rewarding profitable, retainable WSEs, not just signatures.</li>
          <li><b>An HRBP is a partner, not a rubber stamp.</b> The best HR partner I have worked with told me a hire was wrong before I could see it, and was right. That is what I want: someone who sees the patterns I cannot from the inside. In the first 90 days I would lean on my HRBP for the hiring profile, the performance framework, and getting comp designed the right way the first time.</li>
        </ul>
      </div>
    </div>
  );
